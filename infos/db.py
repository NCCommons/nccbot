"""
python3 core8/pwb.py infos/db 54575469
python3 core8/pwb.py infos/db test3

from infos.db import find_data # find_data(url="", urlid="", file="")
from infos.db import insert_all_infos # insert_all_infos(data_list, prnt=True)
from infos.db import insert_url_file # insert_url_file(url, file)
